...
// запуск конкретной функции - точное совпадение
...
// запустить только одну bench функцию - по точному имени
...
// создать профили тестирования
// go test -bench=. -benchmem -cpuprofile=cpu.prof -memprofile=mem.prof ./utils

// сгенерировать svg файлы с графами вычислений
